...
DCT_MAX_VALUE_HIGH10 : 65536,
DCT_MAX_VALUE_HIGH12 : 262144,
...
COEFF_CONTEXTS : 6, 
BAND_COEFF_CONTEXTS(band) ((band) == 0 ? 3 : COEFF_CONTEXTS)
...
MODEL_NODES : (this.ENTROPY_NODES - this.UNCONSTRAINED_NODES),
...
combine_entropy_contexts: function( a, b) {
  return (a != 0) + (b != 0);
}

get_entropy_context(tx_size, const ENTROPY_CONTEXT *a,
