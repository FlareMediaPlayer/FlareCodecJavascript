...
inv_recenter_nonneg : function(v, m) {
  if (v > 2 * m)
    return v;
...
/*
decode_uniform : function(vpx_reader *r) {
  var l = 8;
  var m = (1 << l) - 191;
  var v = vpx_read_literal(r, l - 1);
  return v < m ?  v : (v << 1) - m + vpx_read_bit(r);
  
},
    */
/*
inv_remap_prob : function( v,  m) {
...
decode_term_subexp : function(vpx_reader *r) {
  if (!vpx_read_bit(r))
...
vp9_diff_update_prob : function(vpx_reader *r, vpx_prob* p) {
